...
async function update_configuration_file(
    ...
    // Patch the PATH to avoid the weird "NOT FOUND" error
    configuration_stanza_accessor.qualifiedPath =
        configuration_stanza_accessor._links.alternate;
...
function create_configuration_file(
    ...
    return configurations_accessor.create(
        configuration_file_name,
        function (_error_response, _created_file) {
            // Do nothing
        }
    );
}
...
function create_stanza(configuration_file_accessor, new_stanza_name) {
    ...
    return configuration_file_accessor.create(
        new_stanza_name,
        function (error_response, created_stanza) {
            // Do nothing
        }
    );
}
...
export { update_configuration_file, get_configuration };
